export const ar = {
  ...
  endTimeMessage: "الوقت يكون 45 دقيقة بعد وقت البدء",
  addToList: "أضف إلى القائمة",
  noSlotsToAdd: "لا توجد فترات لإضافتها",
  clear: "مسح",
  pendingSlots: "الفترات المختارة",
  ...
  codeRequired: "رمز التأكيد مطلوب.",
  ...
  initiateSuccess: "تم إرسال رمز التأكيد إلى بريدك الإلكتروني.",
