export const en = {
  ...
  orderProceed: "Order Proceeded",
  orderCompleted: "Order Completed",
  pleaseLogin: "Please login to continue",
  errorRejectingOrder: "Error rejecting order",
  errorAcceptingOrder: "Error accepting order",
  errorProceedingOrder: "Error proceeding order",
  ...
  endTimeMessage: "45 minutes by default after start time",
  addToList: "Add to List",
  noSlotsToAdd: "No slots to add",
  clear: "Clear",
  ...
  initiateSuccess: "Confirmation code sent to your email.",
