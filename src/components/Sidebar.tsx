...
export default function Sidebar({ mobileOpen, setMobileOpen }: SidebarProps) {
  return (
    <>
      <aside
        className={cn(
          "fixed left-0 top-0 z-40 h-screen w-40 md:w-52 border-r border-stone-200 bg-stone-50 transition-transform overflow-y-auto",
      ...
      >
        <div className="flex h-full flex-col justify-between">
          ...
          <div className="p-4">
            <button className="w-full h-10 rounded-md justify-center flex items-center font-semibold gap-2  text-blue-950 hover:bg-stone-200 ">
