...
// Extend the WalletData interface to include balanceType
export interface WalletData {
  ...
  balanceDetails: {
    ...
    dueAmount: number;
    balanceType: "REFUNDED" | "SERVICE"; // ← new field
  }[];
}
...
const translations = {
  en: {
    ...
    totalBalance: "Total Deduction Amount",
  ...
  ar: {
    ...
    totalBalance: "مبلغ الخصم الإجمالي",
    netBalance: "الرصيد الإجمالي",
    ...
    type: "النوع", // ← new key
    refunded: "مرتجع", // ← new key
    service: "خدمة", // ← new key
    page: "صفحة",
    of: "من",
...
export const downloadPDF = (data: WalletData, filename: string) => {
  ...
  // Add transactions table with the new "Type" column
  autoTable(doc, {
    startY: 60,
    head: [
      [
    ...
    body: data.balanceDetails.map((detail) => [
      ...
      detail.balanceType === "REFUNDED" ? t("refunded") : t("service"),
    ]),
